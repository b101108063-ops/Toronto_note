# Commonly Used Abbreviations (醫學常用縮寫)
...
| ACE | angiotensin-converting enzyme | 血管張力素轉化酶 |
| ACTH | adrenocorticotropic hormone | 腎上腺皮質促素 |
| ADH | antidiuretic hormone | 抗利尿激素 |
| AIDS | acquired immune deficiency syndrome | 後天免疫缺乏症候群 |
| ALP | alkaline phosphatase | 鹼性磷酸酶 |
| ALT | alanine aminotransferase | 丙胺酸轉胺酶 |
| AST | aspartate transaminase | 天門冬胺酸轉胺酶 |
| BID | twice a day | 每日兩次 |
| BMI | body mass index | 身體質量指數 |
| BP | blood pressure | 血壓 |
| BSA | body surface area | 身體表面積 |
...
| DNR | do not resuscitate | 不施行復甦術 |
| ECG | electrocardiogram | 心電圖 |
| EEG | electroencephalogram | 腦電圖 |
| EMG | electromyography | 肌電圖 |
| ENT | ears, nose, and throat | 耳鼻喉科 |
| ESR | erythrocyte sedimentation rate | 紅血球沉降速率 |
| FSH | follicle stimulating hormone | 濾泡刺激素 |
| GFR | glomerular filtration rate | 腎絲球濾過率 |
| GH | growth hormone | 生長激素 |
| GGT | gamma-glutamyl transferase | 伽瑪麩胺醯轉移酶 |
| GI | gastrointestinal | 胃腸道的 |
| GU | genitourinary | 泌尿生殖系統 |
...
| NG | nasogastric | 鼻胃管 |
| NKF | National Kidney Foundation | 國家腎臟基金會 |
| NSAID | non-steroidal anti-inflammatory drug | 非類固醇抗發炎藥 |
| OCD | obsessive-compulsive disorder | 強迫症 |
| PCP | Pneumocystis jirovecii pneumonia | 肺囊蟲肺炎 |
| PID | pelvic inflammatory disease | 骨盆腔發炎疾病 |
...
| SIADH | syndrome of inappropriate ADH | 抗利尿激素分泌不當症候群 |
| SLE | systemic lupus erythematosus | 系統性紅斑狼瘡 |
| T3 | triiodothyronine | 三碘甲狀腺素 |
| T4 | thyroxine | 甲狀腺素 |
| TB | tuberculosis | 結核病 |
